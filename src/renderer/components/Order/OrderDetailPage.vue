...
<div class="content-page">
  ...
  <div class="content_detail">
    ...
    <el-card class="box-card">
      ...
      <div class="box_card_item">
        ...
        <div class="box_card_item_right">{{orderInfo.pay_localtime}}</div>
      </div>
      <div class="box_card_item">
      ...
      <div class="box_card_item">
        ...
        <div class="box_card_item_right">{{orderInfo.postscript}}</div>
      </div>
      <div class="box_card_item">
  ...
  <el-button style="float:right" type="danger">删除订单</el-button>
</div>
