      ...
      <div class="content-main">
          ...
          <div class="form-table-box">
              <el-table :data="tableData" :default-sort = "{prop: 'date', order: 'descending'}" style="width: 100%" border stripe>
                  ...
                  <el-table-column prop="coupon_name" align="center" sortable  label="名称" >
                  </el-table-column>
                  <el-table-column prop="Instructions" align="center" sortable  label="注明">
                  </el-table-column>
                  <!-- <el-table-column prop="disprice" align="center" sortable width="150" label="减免价格(元)">
                  </el-table-column> -->
                  <el-table-column prop="create_localtime" align="center" sortable width="170" label="创建时间">
                  </el-table-column>
                  <el-table-column  align="center" sortable width="110" label="剩余(张)">
